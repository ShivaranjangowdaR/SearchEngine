...
public class Logout {
	...
	public void logout() throws InvalidRootFinderException {
		System.out.println("Enter 1 for logout or enter 2 fro continue searching or enter 3 for searching using concurrency");
...
//				System.out.println("Eneter file name for search");
